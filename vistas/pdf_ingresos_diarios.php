...
$i =1;
$total = 0;
$sql="SELECT  * FROM  cita_cnslt INNER JOIN pacnt_cnslt ON (cita_cnslt.ci_pacnt_cita = pacnt_cnslt.ci_pacnt) Where fecha_cita  = '$fecha' AND estatus = '1'";
$query = pg_query($CONEXION, $sql) or die('ERROR AL INSERTAR DATOS: ' . pg_last_error());
$result=pg_fetch_all($query);

$html= '
							<br><h3>Ingresos Diarios</h3><br>
...
$pdf->pdf( $titulo = 'Ingresos Diarios', $formato = 'A4' , $orientacion = 'P' , $html, $archivo = 'ingresos_diarios');
