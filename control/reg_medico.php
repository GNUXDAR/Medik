...
$localizar=pg_num_rows($verifica);
	if ($localizar==0) {
		...
		$INSERTAR=pg_query($conectando->conectar(), "INSERT INTO medic_cnslt (ci_medic, nom_medic, apel_medic, fn_medic, dir_medic, mail_medic, tlf_medic, espc_medic, cod_tlf)
		VALUES ('$ci_medic', '$nom_medic', '$apel_medic', '$fn_medic', '$dir_medic', '$mail_medic', '$tlf_medic', '$espc_medic', '$cod_tlf')");	
